...
export default function RentalTypeDropdown() {
  const [isOpen, setIsOpen] = useState(false);
  const [selectedOption, setSelectedOption] = useState("Rental Type");
  const [showmenu, setShowMenu] = useState(false);
  const [effectActive, setEffectActive] = useState(false);

  const vehicletype = [{ label: "With Driver" }, { label: "Self-Drive" }];
